"""A hello-world filter plugin in namespacecheck.collectionamecheck."""
...
DOCUMENTATION = """
    name: hello_world
    author: Namespacecheck Collectionamecheck
    version_added: "1.0.0"
...
- name: Display a hello message
  ansible.builtin.debug:
    msg: "{{ 'ansible-creator' | namespacecheck.collectionamecheck.hello_world }}"
"""
